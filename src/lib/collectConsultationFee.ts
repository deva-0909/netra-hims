...
const MODULE_LABEL: Record<string, string> = {
  general: 'General OPD', retina: 'Retina', glaucoma: 'Glaucoma', lasik: 'LASIK / Refractive', cornea: 'Cornea', oculoplasty: 'Oculoplasty', uveitis: 'Uveitis', low_vision: 'Low Vision', pediatric: 'Pediatric Ophthalmology',
};
