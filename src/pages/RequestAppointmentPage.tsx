...
const CLINICS = [
  ...
  { value: 'oculoplasty', label: 'Oculoplasty Clinic' },
  { value: 'uveitis', label: 'Uveitis Clinic' },
  { value: 'low_vision', label: 'Low Vision Clinic' },
    ...
    <div style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', background: 'var(--color-bg)', padding: 'var(--space-4)' }}>
      <form onSubmit={submit} className="card blueprint elev-md" style={{ width: 'min(440px, 100%)', padding: 'var(--space-6)' }}>
        ...
        <div className="field" style={{ marginBottom: 'var(--space-3)' }}>
          ...
          <input id="preferred_date" className="input" type="date" min={new Date().toISOString().slice(0, 10)} value={form.preferred_date} onChange={(e) => set('preferred_date', e.target.value)} />
        </div>
        <div className="field" style={{ marginBottom: 'var(--space-3)' }}>
