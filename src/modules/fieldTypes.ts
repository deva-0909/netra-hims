export type FieldType = 'text' | 'textarea' | 'number' | 'select' | 'checkbox' | 'date' | 'datetime';
...
export interface StageConfig {
  ...
  description?: string;
  custom?: 'pharmacy' | 'admission' | 'billing'; // rendered by a bespoke component instead of the generic form
}
